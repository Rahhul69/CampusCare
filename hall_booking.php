    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="auth-buttons">
                <a href="student_login.php" class="btn btn-outline-light btn-sm">
    ...
    <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" id="bookingForm">
        ...
        <div class="form-step active" id="step1">
            <div class="custom-form-group">
                ...
                <input type="text" class="form-control <?= !empty($errors['name']) ? 'is-invalid' : ''; ?>" id="name" name="name" placeholder="Enter your full name" value="<?= isset($name) ? $name : ''; ?>" required>
            ...
            <div class="custom-form-group">
                ...
                <select class="form-select <?= !empty($errors['hall']) ? 'is-invalid' : ''; ?>" id="hall" name="hall" required>
                    <option value="" disabled <?= !isset($hall) ? 'selected' : ''; ?>>Choose a hall</option>
                    <option value="Eric Mathias Hall" <?= (isset($hall) && $hall == 'Eric Mathias Hall') ? 'selected' : ''; ?>>Eric Mathias Hall</option>
                    ...
                    <option value="Sanidhya Hall" <?= (isset($hall) && $hall == 'Sanidhya Hall') ? 'selected' : ''; ?>>Sanidhya Hall</option>
                </select>
...
// Replace the existing bookings container section
<div class="bookings-container">
    <?php
    if ($isLoggedIn) {
        // User is logged in, fetch their bookings
        $sql = "SELECT b.*, u.fName, u.lName 
        ...
        <div class="login-prompt">
            ...
            <a href="student_login.php" class="btn btn-primary mt-3">Login Now</a>
        </div>
        <?php
    }
    ?>
...
<style>
    ...
    .no-bookings, .login-prompt {
        text-align: center;
        padding: 3rem;
        color: var(--neutral-dark);
    }

    .no-bookings i, .login-prompt i {
        font-size: 3rem;
        margin-bottom: 1rem;
